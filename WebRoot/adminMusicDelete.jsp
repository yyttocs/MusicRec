			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>System Song List</h2>
					</div>
   
   <% 
    
    ItemBeanCl ibc = new ItemBeanCl();
    ResultSet rs1 = ibc.getAllItems();
	...
	while (!rs1.isAfterLast()){
		...
		ItemBeanCl itb = new ItemBeanCl();
       	String ItemSong = itb.getItemSong(s1);
       	String MusicName = itb.getMusicName(s1);
   	   	String Singer = itb.getSinger(s1);
		int songId = Integer.parseInt(rs1.getString(1));
		/* System.out.println("songname: "+ s1 );*/
	%>
	<tr>
								<td class="center"><%=MusicName%></td>
								<td class="center"><%=Singer%></td>
								<td class="center"><a href="MusicDelete?ItemID=<%=songId%>">点击删除</a></td>
	</tr>
    <%
