...
<body>
    ...
    <!-- start: Header -->
        ...
        <div class="row-fluid">
			...
			int rating = Integer.parseInt(request.getParameter("c"));
		
			ItemRatingCl irc = new ItemRatingCl();
			boolean b = irc.addRating(userId, itemId, rating);
			
			%>
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>评价结果</h2>
					</div>
					<div class="box-content">
					<% if(b){ %>	
							
							 <h2 align="center">您的评分已经生效，感谢您对歌曲的支持！</h2>	
	        				 <center><input type="button" name="goback" value="返回" onClick="javascript:window.history.go(-1)"></center>
					<%	
					} else {
					%>
				<h2 align="center">你已经评价过此歌曲！</h2>	
	        	<center><input type="button" name="goback" value="返回" onClick="javascript:window.history.go(-1)"></center>
