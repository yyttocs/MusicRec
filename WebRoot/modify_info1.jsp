        ...
        <div class="row-fluid">
			...
			<ul class="breadcrumb">
			  ...
			  <%
    			 ...
    			 String s_Eamil = request.getParameter("Email");
    			 int s_Id = Integer.parseInt(request.getParameter("uid"));
   				 UserBeanCl ubc = new UserBeanCl();
   				 boolean b = ubc.setUser(s_Id,s_Sex,s_Eamil);
   				 ubc.close();
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<% if (!b) { %>	
							...
							<h2 align="center">用户资料修改失败！</h2>	
							<center><input type="button" name="goback" value="返回" onClick="javascript:window.history.go(-1)"></center>
					<%	
					} else {
					%>
							<h2 align="center">用户资料修改成功！</h2>	
 							<center><a href="setinfo1.jsp">返回用户设置页面</a>
    						</center>
